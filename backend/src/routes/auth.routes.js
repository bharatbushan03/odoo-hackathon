...
router.post('/register-admin', authLimiter, validators.registerAdmin, validate, authController.registerAdmin);
router.post('/register', authLimiter, validators.registerEmployee, validate, authController.registerEmployee);
...
router.post('/change-password', authLimiter, validators.changePassword, validate, authController.changePassword);
